...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      {/* LINK */}
      <div className="hidden md:flex md:gap-3 xl:gap-8 w-1/3">
        {links.map((link) => (
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        <Link
          href="/"
          className="md:text-sm lg:text-xl bg-black rounded-md p-1 font-semibold flex items-center justify-center"
        >
          <span className="text-white mr-2">Atul</span>
      ...
      {/* SOCIAL */}
      <div className="hidden md:flex md:justify-end lg:justify-end gap-4 w-1/3">
        <Link href="https://github.com/aksxy007" target="/blank">
